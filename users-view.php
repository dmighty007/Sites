    ...
    <body style="background: #f1f1f1">
        ...
        <main role="main" class="container">
            <div class="mx-5">
                ...
                <div >
                  <h5 class="border-bottom border-gray pb-2 mb-0">Find Peoples</h5>
                          ...
                          { 
                              ...
                              <a href="profile.php?id='.$row['idUsers'].'">
                                    <div class="media pt-3">
                                      <div class="mr-2 rounded-circle div-img list-user-img">
                                      
                                      <div class="profile_namex" id='.$row['f_name'].'></div>
                                      </div>
        ...
        <script>     
            ...
            var cl=document.getElementsByClassName('profile_namex') 
            for (let i = 0; i < cl.length; i++){
                var idnew=cl[i].id;
                console.log(cl[i].id);
                //let 
                getById(cl[i].id).innerHTML = multiavatar(cl[i].id);}
            //console.log(<?php echo ucwords($user['f_name'])?>);}
        </script>
