                    ...
                    echo '<a href="blog-page.php?id='.$row['blog_id'].'">
                        <div class="media text-muted pt-3">
                            ...
                            <span class="text-right text-primary"><i class="fa fa-thumbs-up" aria-hidden="true"></i>
                                '.$row['blog_votes'].'<br>';
                    $sql2 = "SELECT * FROM blogs WHERE blog_id=".$row['blog_id']."";
                    $result23 = $conn->query($sql2);
                    $row23 = $result23->fetch_assoc();

                    #echo "id: " . $row23["blog_id"]. " - Name: " . $row23["blog_by"]. "<br>";
                    if (($_SESSION['userLevel'] == 1 )|| ($_SESSION['userId'] == $row23['blog_by']))
                    {
                        $val = $row['blog_by'];
                        echo '<a href="included/delete-blog.php?id='.$row['blog_id'].'&page=forum" >
        ...
        <?php
            ...
            else
            {
                ...
                while ($row = mysqli_fetch_assoc($result))
                {
                    ...
                    {
                        echo '<a href="included/delete-event.php?id='.$row['event_id'].'&page=forum" >
                                <i class="fa fa-trash" aria-hidden="true" style="color: red;"></i>
                              </a>
                            </span>';
                    }
