...
?> 
    ...
    <body>
        ...
        <div class="cover">
                      ...
                      <a href='./message.php?id=<?php echo $row['idUsers']; ?>'><div class="chat_list ">
                            <div class="chat_people">
                                <div class="chat_img"> 
                                    ...
                                    <div class="cxxxd" id=<?php echo $row['f_name'] ?>></div>
                                </div>
                              <div class="chat_ib">
                                <br>
                                <h5>
            ...
            //document.getElementById('64e56d80fbe27ec72a1d').innerHTML = multiavatar('64e56d80fbe27ec72a1d');
            var l = document.getElementsByClassName("cxxxd").length;
            var cl = document.getElementsByClassName("cxxxd");
