            ...
            <div class="collapse navbar-collapse " id="navbarSupportedContent">
                <ul class="navbar-nav nav-dropdown" data-app-modern-menu="true">
                    <li class="nav-item hvr-bounce-in" ><a class="nav-link link text-blue display-4" href="index.php">
                        <span class="card__link2">Home</span>
...
<div class="main-container">
  <div class="heading">
    <h1 class="heading__title">Lifestyle Related Issues</h1>
    <p class="heading__credits"><a class="heading__link" target="_blank" href="#">The issues posted with the category lifestyle..
    </a></p>
  </div>
  <div class="cards">
    <?php $sql = "select * from topics where topic_cat = $item_id[1]    
                    order by topic_date ";
            ...
            echo '
                ...
                <div class="card__icon"><i class="fa-solid fa-heart" aria-hidden = "true" style="color:pink;"></i></div>
