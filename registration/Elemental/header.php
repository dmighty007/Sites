  ...
  <link rel="preload" href="https://fonts.googleapis.com/css?family=Zen+Antique+Soft:400&display=swap" as="style" onload="this.onload=null;this.rel='stylesheet'">
  <noscript><link rel="stylesheet" href="https://fonts.googleapis.com/css?family=Zen+Antique+Soft:400&display=swap"></noscript>
...
<body>
  ...
  <section data-bs-version="5.1" class="menu menu3 cid-sFAA5oUu2Y" once="menu" id="menu3-0">
    ...
    <nav class="navbar navbar-dropdown navbar-expand-lg" style="position:relative;">
        <div class="container-fluid">
            <div class="navbar-brand">
                
                <span class="navbar-caption-wrap"><a class="navbar-caption text-primary display-5" href="../index.php">Scrapped</a></span>
            </div>
                ...
                <div class="icons-menu">
                  <!--
                    <a class="iconfont-wrapper" href="https://mobiri.se" target="_blank">
                        <span class="p-2 mbr-iconfont mbrib-search"></span>
                    </a>
                  -->
