...
if (isset($_POST['create-topic']))
{
    ...
    {
        $sql = "insert into topics(topic_subject, topic_date, topic_cat, topic_by, topic_content) "
                . "values (?,now(),?,?,?)";
        ...
        {
            mysqli_stmt_bind_param($stmt, "ssss", $topicSubject, $topicCategory, $_SESSION['userId'], $postContent);
