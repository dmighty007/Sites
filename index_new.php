    ...
    <div id="content" style="display: none">
        ...
        <div class="container-fluid">
            ...
            <div class="col-sm-12">
                ...
                <a href="forum.php" class="btn btn-warning btn-lg btn-block"><i class="fa fa-hand-o-right" aria-hidden="true"></i> Forum</a>
                <a href="hub.php" class="btn btn-secondary btn-lg btn-block"><i class="fa fa-hand-o-right" aria-hidden="true"></i> The Hub</a>
                <br><br><br>
