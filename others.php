...
<div class="main-container">
  <div class="heading">
    <h1 class="heading__title">Other Issues</h1>
    <p class="heading__credits"><a class="heading__link" target="_blank" href="#">The issues posted with the category `others`..
    </a></p>
  </div>
  <div class="cards">
    <?php $sql = "select * from topics where topic_cat = $item_id[2]    
                    order by topic_date ";
            ...
            echo '
                ...
                <div class="card__icon"><i class="fa-regular fa-snowflake"></i></div>
